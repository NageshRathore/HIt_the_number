...
PLAYBTN.addEventListener("click", function () {
  ...
  if (userName.length == 0 || userTime.length == 0) {
    ...
    Swal.fire({
      ...
      html: '<p>A thrilling game of precision and speed! In this fast-paced challenge, your goal is to hit the target number displayed under hit bubble. Are you ready to test your accuracy and reflexes? </p> ',
